...
reach out to me at cchung@conncoll.edu or Auden at awoolfson@conncoll.edu. The code behind the algorithm is available to view at https://github.com/awoolfson/course-registration-sim/tree/validation.
